            ...
            < Box sx={{
                ...
                <Box sx={{
                    ...
                    <Box sx={{
                        ...
                        <Box width="500px" height="72px" backgroundColor="#D9D9D9"></Box>
                        <Typography width="100%" align="right"> Top Margin <b>72</b> </Typography>
                        <Box width="500px" height="30px" backgroundColor="#D9D9D9"></Box>
                        <Typography width="100%" align="right"> Section padding <b>30</b> </Typography>
                        <Box width="500px" height="16px" backgroundColor="#D9D9D9"></Box>
                        <Typography width="100%" align="right"> Text padding <b>16</b> </Typography>
                        <Box width="500px" height="8px" backgroundColor="#D9D9D9"></Box>
