        ...
        <Box sx={{
          ...
          <Box sx={{
            ...
            <Stack gap="32px" sx={{
              ...
              <Typography variant="heading3" color="#5B5B5B"> currently creating intuitive and accessible products at <Link to={"https://www.designconsultingcornell.com/"} target="_blank" rel="noopener noreferrer">Design Consulting @ Cornell</Link></Typography>
            </Stack>
          </Box>
        </Box>
      </Box >
